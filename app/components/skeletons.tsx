export function DispenserSkeleton() {
  return (
    <div className="flex flex-col justify-items-center h-80 w-80 rounded-xl bg-gray-50 p-2 shadow-lg">
      <p
        className='animate-pulse truncate rounded-xl bg-white px-4 py-8 text-center text-2xl'
      >
      </p>
      <button className="animate-pulse flex flex-row justify-items-center mt-4 h-32 rounded-lg bg-gray-200 font-extrabold items-center">
